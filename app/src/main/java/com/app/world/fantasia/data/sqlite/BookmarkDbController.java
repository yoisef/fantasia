package com.app.world.fantasia.data.sqlite;
...
public class BookmarkDbController {
    ...
    public int insertData(int postId, String postImage, String postTitle, String postExcerpt, String postUrl, String postDate) {
        ...
        values.put(DbConstants.COLUMN_POST_EXCERPT, postExcerpt);
    ...
    public ArrayList<BookmarkModel> getAllData() {
        ...
        String[] projection = {
                ...
                DbConstants.COLUMN_POST_EXCERPT,
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    String postExcerpt = c.getString(c.getColumnIndexOrThrow(DbConstants.COLUMN_POST_EXCERPT));
                    ...
                    favDataArray.add(new BookmarkModel(itemId, postId, postImage, postTitle, postExcerpt, postUrl, postDate));
                } while (c.moveToNext());
            }
            c.close();
        }
