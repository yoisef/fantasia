package com.app.world.fantasia.data.constant;
...
public class AppConstant {
    ...
    public static final String SAVE_TO = "ANewZ";
    ...
    public static final int BUNDLE_KEY_LATEST_POST_ID = -1;
    public static final int BUNDLE_KEY_FEATURED_POST_ID = -2;
    public static final int BUNDLE_KEY_SEARCH_POST_ID = -3;


    public static final String TTS_LOCALE = "ar_EG";

    // replace by your site url
    public static final String BASE_URL = "https://fantasia.world/ar/";
